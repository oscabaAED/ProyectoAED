...
Para complementar este análisis, se calcularon los valores absolutos de nacimientos por nombre y su proporción respecto al total, con el fin de evaluar las frecuencias acumuladas a lo largo del periodo 1930–2020.
...
cada_sexo_nb <- Nombres_tidy %>%
  ...
  group_by(Nombre) %>%
  summarise(`% Hombres`=round(Hombre*100/(Hombre+Mujer),2), `% Mujeres`=round(Mujer*100/(Hombre+Mujer),2))
