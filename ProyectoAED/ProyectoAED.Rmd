...
OJO ESTAN REPETIDOS, ELEGIR UNO (igual el de arriba es mas claro y bonito)
# Objetivos 
...
A partir de dicho sumario se puede identificar una característica fundamental del conjunto de datos: la distribución frecuencial presenta una gran cantidad de nombres a bajas frecuencias, como podemos deducir a partir de la mediana y los cuartiles, pero la media y el máximo de frecuencia de los nombres son muy superiores a estos valores.   

En consecuencia, nuestro conjunto de datos presenta una distribución de frecuencias no gaussiana, dado que cuenta con una gran cantidad de nombres a baja frecuencia, y la cantidad de nacimientos se encuentra concentrada mayoritariamente en unos pocos nombres. 
Por este motivo no es conveniente usar las técnicas usuales, adaptadas a esta distribución. En su lugar, se emplearán métodos exploratorios y visuales que permitan captar adecuadamente esta asimetría y las posibles tendencias en el conjunto de nombres.
...
Apartir de esta distribución, accedemos a los nombres más populares, de los cuales seleccionamos unicamente los 25 primeros para realizar un análisis de su evolución temporal mediante un heatmap, mostrado a continuación.  
