...
if(knitr::is_latex_output()){
  ...
  mitad <- 1:floor(nrow(cada_sexo_nb)/2)
  kable(list(cada_sexo_nb[mitad,],  
           matrix(numeric(), nrow=0, ncol=1),
           cada_sexo_nb[-mitad, 1:2]),
