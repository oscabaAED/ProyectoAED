...
Para determinados análisis también es conveniente tener datos absolutos sobre la cantidad de nacimientos totales para cada nombre y su proporción, obtendremos esta información a partir de la manipulación de nuestro dataframe _tidy_ original.  
