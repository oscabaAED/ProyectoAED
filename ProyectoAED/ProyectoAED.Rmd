...
df_1930 <- Nom_populares %>%
  filter(Decada == '1930')
g1930<-ggplot(data=df_1930, aes(x=Nombre, y=Nac.)) + geom_col(aes(fill = Sexo)) + facet_grid(~ Sexo) + xlab('Nombres') + ylab('Número de Nacimientos') + ggtitle('5 Nombres más populares en 1930 en la provincia de Valencia') + theme(axis.text.x = element_text(angle=45))
g1930
```
