...
En primer lugar es conveniente conocer, de manera general, las características de el conjunto de datos con el que vamos a trabajar. Para ello haremos un sumario inicial de los datos en formato _tidy_.   
```{r echo=FALSE}
...
Comenzando con el objetivo Nº 1, realizamos un estudio que muestra los cinco nombres más frecuentes por sexo en cada década comprendida entre 1930 y 2020.  Esta información se obtiene a partir de la manipulación del dataframe _tidy_ creado, mediante la agrupación por sexo y decada, así como el ordenamiento acorde a la cantidad de personas con ese nombre. Aunque el procedimiento se aplico al conjunto completo de décadas, en este artículo solo se presentan las visualizaciones correspondientes a los años 1930, 2000 y 2020, seleccionadas por su valor representativo y por motivos de espacio. 
Estas 3 decadas permiten observar con claridad la evolución de las preferencias en la elección de nombres a lo largo del tiempo.  En 1930, predominan nombres de carácter tradicional y religioso, mientras que en el año 2000 los nombres más comunes denotan una diversificación y clara influencias de modas globales. Finalmente, en 2020, se observa una preferencia por nombres breves y modernos, incluyendo nombres de origen valenciano como 'Marc'.
...
Dado la variabilidad de estos resultados, realizamos un análisis de los datos absolutos sobre la cantidad de nacimientos totales para cada nombre y su proporción, de esta manera, explorando las frecuencias totales de los nombres a lo largo del periodo estudiado. 
A continuación, en la siguiente tabla se presenta la cabecera de este conjunto de datos, en el cual se exponen los 6 nombres más populares a lo largo del periodo 1930-2020, como representativo del conjunto completo.
...
Mediante esta distribución realizada, logramos acceder a los nombres más populares, de los cuales escogimos utilizar unicamente los 25 primeros para realizar un análisis de su evolución temporal mediante un heatmap, el cual se muestra a continuación.  
