...
# Función para los gráficos de esta sección
grafico_evolucion <- function(data, y_var, y_lab, title, subtitle, y_format = waiver()){
  
  # Convertimos el nombre de la columna de forma que aes() lo entienda 
  y_sym <- sym(y_var)
...
grafico_evolucion(
  ...
  y_format = scales::label_number(accuracy = 0.1, suffix = " %")
)
