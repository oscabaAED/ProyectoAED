...
p_load(ggplot2, visdat) # Visualización
p_load(patchwork) # Agrupación de plots
p_load(knitr, kableExtra, flextable, gt, gtsummary) # Para tablas
```
...
nombres_seleccionados <- c("MARC", "JOAN", "VICENT")
