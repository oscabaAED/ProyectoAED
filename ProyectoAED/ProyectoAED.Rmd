...
```{r, echo=FALSE, out.width='75%', fig.align='center', fig.cap="Visualización de la estructura inicial de los datos."}
...
```{r, echo=FALSE, out.width='60%', fig.align='center', fig.cap="Visualización de la estructura de los datos en formato tidy."}
...
En la siguiente tabla se muestra la cabecera de este conjunto de datos, que incluye los seis nombres más populares del periodo analizado como muestra representativa.
...
```{r, echo=FALSE, out.width='60%', fig.align='center', fig.cap="Popularidad de los 25 nombres más frecuentes por década."}
...
```{r, echo=FALSE, out.width='60%', fig.align='center', fig.cap="Evolución de nombres valencianos populares."}
...
En cuanto a los nombres unisex, entendidos como aquellos registrados en ambos sexos, representan un porcentaje marginal dentro del conjunto (`r porcentaje_nb`) y, en la mayoría de los casos, su distribución se inclina de forma pronunciada hacia uno de los dos sexos.
...
```{r echo = FALSE, fig.cap="Total de nacimientos (A) y variedad de nombres distintos (B) por década."}
(plot_nacimientos / plot_variedad) + 
  plot_annotation(tag_levels = 'A')
```


```{r echo = FALSE, fig.cap="Porcentaje de nombres compuestos (A) y longitud promedio de los nombres (B) por década."}
(plot_compuestos / plot_longitud) + 
  plot_annotation(tag_levels = 'A')
```


```{r echo = FALSE, fig.cap="Aparición de nuevos nombres (A) y desaparición de nombres (B) por década."}
...
=======
>>>>>>> d33271014c368abab12cfb433df3e990df8ee874
...
```{r echo = FALSE, results='hide', fig.cap="Ranking de nombres de la clase en la década de los 2000."}
