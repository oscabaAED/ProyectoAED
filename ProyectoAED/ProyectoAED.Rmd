...
header-includes:
  ...
  - \setkeys{Gin}{width=\linewidth,keepaspectratio} % toda imagen cabe en el ancho de texto
---
...
knitr::opts_chunk$set(
  fig.align = "center",
  out.width = "\\linewidth",   # respeta márgenes de la plantilla
  fig.pos = "H"                # coloca la figura y reduce cortes
)
```
