...
A partir de dicho sumario se identifica una característica fundamental del conjunto de datos: la distribución frecuencial presenta una elevada cantidad de nombres con baja incidencia, como podemos deducir a partir de la mediana y los cuartiles, pero la media y el máximo de frecuencia de los nombres son muy superiores a estos valores.   
...
A partir de esta distribución, accedemos a los nombres más populares, de los cuales seleccionamos unicamente los 25 primeros para realizar un análisis de su evolución temporal mediante un heatmap, el cual se expone a continuación.  
...
En cuanto a los nombres unisex, entendidos como aquellos registrados en ambos sexos, representan un porcentaje marginal dentro del conjunto (`r porcentaje_nb`) y, en la mayoría de los casos, su distribución se inclina de forma pronunciada hacia uno de los dos géneros.
...
- Características de los nombres: Analiza cambios estilísticos, como el porcentaje de nombres compuestos y la longitud media de los nombres respecto al total. Ambas gráficas presentan un incremento inicial hasta mediados del siglo XX y una reducción continua en las décadas posteriores. Estos cambios revelan tendencias culturales, evidenciando el abandono de nombres largos y tradicionales en favor de opciones más breves.

- Renovación: Estudia la aparición y la desaparición de nombres por década. Por un lado, el número de nuevas incorporaciones tiene máximos locales en 1960 y los años 2000. Consecuentemente, tras un periodo de mayor creatividad, las siguientes decadas aumenta la cantidad de nombres que caen en desuso, teniendo picos en los años 1970 y 2010.
